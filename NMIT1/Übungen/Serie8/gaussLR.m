...
% Implementierung der Gauss-Elimination zur Lösung von linearen
% Gleichungssystemen, zusätzlich mit einer LR-Zerlegung
% Parameter: Matrix A, Vektor b
% Rückgabewerte: untere normierte Dreiecksmatrix L, obere Dreiecksmatrix R,
